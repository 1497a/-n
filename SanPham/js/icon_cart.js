    ...
    if (cartItems && productContainer) {
        ...
        Object.values(cartItems).map(item => {
           ...
           <div class="product-title">
            ...
            <div class="product-price">${item.price.toLocaleString('de-DE')} Đ</div>
            <div class="product-quantity">  ${item.inCart}</div>    
            <div class="product-total">${(item.inCart*item.price).toLocaleString('de-DE')} Đ</div>
            `
        });
        ...
        <a class="valueTotal">${cartCost.toLocaleString('de-DE')} Đ</a>
        </div>
